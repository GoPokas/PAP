                            ...
                            <tbody class="">
                                ...
                                ?>
                                    <tr class="odd:bg-white even:bg-gray-100 h-9">
                                        ...
                                        <td>
                                            <a class="items-end" href="requests_details.php?request=<?php echo $row['id_marcacao']; ?>">
                                                <svg xmlns=" http://www.w3.org/2000/svg" class="h-5 w-5 opacity-70 hover:opacity-100" viewBox="0 0 20 20" fill="currentColor">
