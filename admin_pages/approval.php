                            ...
                            <tbody class="">
                                ...
                                ?>
                                        <tr class="odd:bg-white even:bg-gray-100 h-9">
                                            ...
                                            <td>
                                                <form action="../functions/approve.php" method="POST" id="my_form" class="my-auto flex">
                                                    ...
                                                    <button type="submit" class="justify-center opacity-70 hover:opacity-100" name="disapprove" value="<?php echo $row['id_marcacao']; ?>">
                                                        <svg xmlns=" http://www.w3.org/2000/svg" class="h-7 w-7" viewBox="0 0 20 20" fill="#FF0000">
                                                            <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd" />
                                                        </svg>
                                                    </button>
                                                    <a class="justify-center opacity-70 hover:opacity-100" href="../pages/requests_details.php?request=<?php echo $row['id_marcacao']; ?>">
