...
class FlashMessages
{
    ...
    protected $msgWrapper = "<div id='alert-border-1' class='%s' role='alert'>%s</div>";
    ...
    protected $closeBtn  = '<button type="button" class="ml-auto -mx-1.5 -my-1.5 text-gray-500 rounded-lg inline-flex h-8 w-8" data-dismiss-target="#alert-border-1" aria-label="Close">
